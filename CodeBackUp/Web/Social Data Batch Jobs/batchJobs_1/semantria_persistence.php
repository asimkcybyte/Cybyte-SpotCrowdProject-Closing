...
class SemantriaPagePersistence
{
    ...
    {
    	$sa_data = array();
    	$selQuery = "select * from wp_facebook_feed_comment where DATE(publishdate) = CURDATE() and title != '' and description != ''";
    	$this->m_persistence->SelectQuery($selQuery);
    	if(count($this->m_persistence->m_data_rows ) >0)
    	{
    		foreach ($this->m_persistence->m_data_rows as $row_data)
    ...
    {
    	$sa_data = array();
    	$selQuery = "select * from wp_twitter_feed_comment where DATE(publishdate) = CURDATE() and title != '' and description != ''";
    	$this->m_persistence->SelectQuery($selQuery);
    	if(count($this->m_persistence->m_data_rows ) >0)
    	{
    		foreach ($this->m_persistence->m_data_rows as $row_data)
    ...
    {
    	$sa_data = array();
    	$selQuery = "select * from wp_reddit_feed_comment where DATE(publishdate) = CURDATE() and title != '' and description != ''";
    	$this->m_persistence->SelectQuery($selQuery);
    	if(count($this->m_persistence->m_data_rows ) >0)
    	{
    		foreach ($this->m_persistence->m_data_rows as $row_data)
    ...
    {
    	$sa_data = array();
    	$selQuery = "select * from wp_instagram_feed_comment where DATE(publishdate) = CURDATE() and title != '' and description != ''";
    	$this->m_persistence->SelectQuery($selQuery);
    	if(count($this->m_persistence->m_data_rows ) >0)
    	{
    		foreach ($this->m_persistence->m_data_rows as $row_data)
