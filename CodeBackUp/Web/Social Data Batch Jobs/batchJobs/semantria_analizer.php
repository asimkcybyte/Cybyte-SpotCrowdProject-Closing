...
class SemantriaAnalyser {
    function analyzeData($initialTexts)
    {
        ...
        foreach ($results as $data) {
            ...
            $analyzedArray[] = array( 'id' => $data["id"],	'score' => $data["sentiment_score"], 'themes' => $data["themes"], 'entities' => $data["entities"], 'phrases' => $data["phrases"]);
			
			/*if ($data["themes"]) {
				$analyzedArray['themes'] = $data["themes"];
